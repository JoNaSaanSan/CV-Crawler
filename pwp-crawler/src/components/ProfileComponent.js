...
class ProfileComponent extends React.Component {
    ...
    handleDownload = (event) => {
        ...
        axios.post('http://pwp.um.ifi.lmu.de/g03/downloadCV', downloadCV) //send POST-request to /downloadCV
    ...
    handleDelete = (event) => {
        ...
        axios.post('http://pwp.um.ifi.lmu.de/g03/deleteUser', deleteUser).then(res => { //send POST-request to /deleteUser
    ...
    handleRegistration = (event) => {
        ...
        axios.post('http://pwp.um.ifi.lmu.de/g03/userRegistration', userRegistration).then(res => { //send POST-request to /userRegistration
            console.log(res.data)
    ...
    handleLogin = (event) => {
        ...
        axios.post('http://pwp.um.ifi.lmu.de/g03/userLogin', userLogin).then(res => {
            console.log(res.data)
            if (res.data.message === "Field empty!") {
                alert("You need to Sign In with Google and fill out the Name and CVURL field!");
            } else {
    ...
    saveSettings = (event) => {
        ...
        axios.post('http://pwp.um.ifi.lmu.de/g03/updateSettings', userSettings).then(res => { //sends the post-request with the user settings to /updateSettings
            console.log(res.data)
